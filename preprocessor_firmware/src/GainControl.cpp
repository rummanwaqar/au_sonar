...
void GainControl::setProportionalGain( float gain ){
    pGain = gain;
}

void GainControl::setIntegralGain( float gain ){
    iGain = gain;
}
...
void GainControl::setNudgeGainValue(float gain){
    nudgeGainValue = gain;
}

void GainControl::setDebugFlag(bool set){
    debugFlag = set;
}
...
float GainControl::getCurrentPeakLevel( void ){
    return peakLevel;
}

int GainControl::getCurrentPingStatus( void ){
    return pingStatus;
}
...
float GainControl::getProportionalGain( void ){
    return pGain;
}
